...
----
1.
For tests to run, the input files must be present in c:\data\dvpr
For confidentiality reasons, the files are not included in the repository.

2. As the files evolve over time, the test may break.
